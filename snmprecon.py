...
if results != "":
    ...
    if snmpdetect == 1:
        ...
        SNMPWALK = "snmpwalk -c public -v1 %s 1 > /root/scripts/recon/recon2/results/%s_snmpwalk.txt" % (ip_address, ip_address)
...
resultsfile = "/root/scripts/recon/recon2/results/" + ip_address + "_snmprecon.txt"
